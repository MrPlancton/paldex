...
class GithubPalModel {
  ...
  factory GithubPalModel.fromJson(Map<String, dynamic> json) =>
      _$GithubPalModelFromJson(json);

  Map<String, dynamic> toJson() => _$GithubPalModelToJson(this);
  ...
  @JsonKey(name: 'typeofpal', required: true, disallowNullValue: true)
